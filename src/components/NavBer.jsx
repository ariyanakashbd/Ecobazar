      ...
      <Container>
       <nav onMouseLeave={()=> setOpen(false)} onMouseLeave={()=>setShopDrop(false)} className='flex justify-between'>
        <ul onMouseLeave={()=>setHomeDrop(false)} className='flex gap-x-8 items-center text-sm font-pop relative'>
          ...
          <li onMouseEnter={()=>setHomeDrop(!homeDrop)}  useRef={homeDropReff}><Link className='flex items-center gap-x-1 text-[#808080] hover:text-white ' to="#">Home <FaAngleDown /></Link></li>
          <li onMouseEnter={()=>setShopDrop(!shopDrop)} useRef={shopDropReff} ><Link className='flex items-center gap-x-1 text-[#808080] hover:text-white ' to="#">Shop <FaAngleDown /></Link></li>
          <li onMouseEnter={()=>setPagesDrop(!pagesDrop)}  useRef={pagesDrop}><Link className='flex items-center gap-x-1 text-[#808080] hover:text-white ' to="#">Pages <FaAngleDown /></Link></li>
          <li onMouseEnter={()=>setBlogDrop(!blogDrop)} useRef={blogDropReff}><Link className='flex items-center gap-x-1 text-[#808080] hover:text-white ' to="#">Blog <FaAngleDown /></Link></li>
          ...
          <div className='bg-[#ffffff] font-pop text-sm  text-[#000000] border-2  w-15  absolute top-11.5 left-48 text-center'>
            <ul>
              <Link><li className='mt-2 hover:bg-primry'>Home1</li></Link>
              <Link><li className='mt-2 hover:bg-primry'>Home2</li></Link>
              <Link><li className='mt-2 hover:bg-primry'>Home3</li></Link>
              <Link><li className='mt-2 hover:bg-primry mb-2'>Home4</li></Link>
            </ul>
          </div>}
          {shopDrop &&
