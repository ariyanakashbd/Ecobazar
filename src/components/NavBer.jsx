...
const NavBer = () => {
  ...
  return (
    <div className='bg-[#0e0d0d] w-full mt-3 sm:mt-5 text-white font-pop'>
      <Container>
        <nav
          onMouseLeave={() => setOpen(false)}
          className='flex justify-between items-center relative py-2 sm:py-3 lg:py-0'
        >
          <div className='flex items-center w-full lg:w-auto'>
            <ul className='flex gap-x-2 sm:gap-x-3 lg:gap-x-8 items-center text-sm font-pop relative w-full lg:w-auto justify-between lg:justify-start'>
              {/* Hamburger Icon */}
              <li
                onClick={() => setSidebar(!sidebar)}
                className='p-2 xs:p-3 lg:p-4 bg-primry lg:mr-30 text-[20px] xs:text-[24px] lg:text-[32px] cursor-pointer'
              >
                <FaBars />
              </li>
              ...
              <li
                ...
                className='lg:hidden p-2 xs:p-3 text-[20px] xs:text-[24px] cursor-pointer'
              >
                <IoMenu />
              </li>
      ...
      <div ref={sidebarRef}>
        <div
          className={`fixed z-50 top-0 left-0 h-full w-[90%] xs:w-[85%] sm:w-100 max-w-[360px] sm:max-w-100 transition-all duration-300 ease-in-out bg-white border border-[#E5E5E5] shadow-2xl shadow-black text-black p-4 sm:p-5 overflow-y-auto
      ...
      <div ref={navMenuRef}>
        <div
          className={`fixed z-50 top-0 right-0 h-full w-[90%] xs:w-[85%] sm:w-100 max-w-[360px] sm:max-w-100 transition-all duration-300 ease-in-out bg-white border border-[#E5E5E5] shadow-2xl shadow-black text-black p-4 sm:p-5 overflow-y-auto
