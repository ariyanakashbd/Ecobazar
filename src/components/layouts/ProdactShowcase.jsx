...
const ProdactShowcase = ({ title, dataPass }) => {
  ...
  return (
    <Container>
      ...
      <div className='flex flex-col lg:flex-row justify-between mt-10 sm:mt-15 mb-8 sm:mb-10 lg:mb-12 font-pop font-normal text-sm items-start lg:items-center'>
        <h2 className='font-pop font-semibold text-[20px] sm:text-[24px] lg:text-[32px] text-[#1A1A1A]'>
          {title}
        </h2>
        <Link
          className='flex items-center font-pop text-[14px] mt-3 sm:mt-5 lg:mt-0 lg:text-[16px] font-medium text-primry'
      ...
      {title === "Hot Deals" ? (
        ...
        <div className='relative mb-10 sm:mb-12 lg:mb-14'>
          <div className='relative z-30 isolate grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 w-full'>
