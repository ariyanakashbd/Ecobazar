  ...
  return (
    ...
    <div className='bg-[#1A1A1A] w-full px-4 md:px-0'>
        <Container>
          ...
          <div className='flex flex-col xs:flex-row md:flex-row flex-wrap lg:flex-nowrap justify-between gap-x-4 gap-y-8 lg:gap-y-0 pt-8 sm:pt-10 lg:pt-0'>
            
           
            <div className='w-full xs:w-[48%] md:w-[48%] lg:w-auto max-w-[336px]'>
            ...
            <div className='w-full xs:w-[45%] md:w-[30%] lg:w-auto lg:mt-8 sm:lg:mt-16.75 text-white font-pop text-[16px]'> 
                <h5>My Account</h5>
                <ul>
                    <li className='text-[#999999] mb-3 text-sm hover:text-white mt-4 sm:mt-5'><Link>My Account</Link></li>
            ...
            <div className='w-full xs:w-[45%] md:w-[30%] lg:w-auto'>
                <div className='lg:mt-8 sm:lg:mt-16.75 text-white font-pop text-[16px] '>
                    <h5>Helps</h5>
                <ul>
                   <li className='text-[#999999] mb-3 text-sm hover:text-white mt-4 sm:mt-5'><Link to="/contact">Contact</Link></li>
            ...
            <div className='w-full xs:w-[45%] md:w-[30%] lg:w-auto'>
                <div className='lg:mt-8 sm:lg:mt-16.75 text-white font-pop text-[16px] '>
                    <h5>Proxy</h5>
                <ul>
                    <li className='text-[#999999] mb-3 text-sm hover:text-white mt-4 sm:mt-5'><Link to="/about">About</Link></li>
            ...
            <div className='w-full xs:w-[45%] md:w-[30%] lg:w-auto'>
                <div className='lg:mt-8 sm:lg:mt-16.75 text-white font-pop text-[16px]'>
                    <h5>Categories</h5>
                <ul>
                    <li className='text-[#999999] mb-3 text-sm hover:text-white mt-4 sm:mt-5'><Link>Fruit & Vegetablesu</Link></li>
          ...
          <div className='border-t border-[#333333] max-w-[1320px] mt-12'>
            <div className='flex flex-col md:flex-row justify-between items-center gap-y-4 md:gap-y-0 py-7 text-center md:text-left'>
              ...
              <div className='cursor-pointer max-w-full w-auto'>
                <img src={freme} alt="payment methods" className="max-w-full h-auto object-contain" />
              </div>
            </div>
          </div>
        </Container>
