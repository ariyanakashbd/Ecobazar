  ...
  return (
    <div>
      <div className='mt-6 mb-5 cursor-pointer' onClick={() => setShow(!show)}>
        <h2 className='flex items-center justify-between font-pop text-[18px] sm:text-[20px] font-medium'>
          {title}
          <span className={`text-base sm:text-[18px] transition-transform duration-300 ease-in-out ${show ? "rotate-180" : "rotate-0"}`}>
            <FaAngleDown />
          </span>
        </h2>
      </div>
