...
const Details = () => {
  ...
  return (
    <Container>
      <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mt-4 sm:mt-6 md:mt-10">
        <div className="w-full lg:w-1/2 flex gap-2 sm:gap-4 h-[240px] xs:h-[280px] sm:h-[340px] md:h-[400px] lg:h-[450px]">
          <div className="w-[44px] xs:w-[50px] sm:w-[70px] flex flex-col justify-between items-center relative h-full shrink-0">
            {/* উপরের কাস্টম বাটন */}
            <button 
              type="button"
              onClick={() => thumbsSwiperRef.current?.swiper?.slidePrev()}
              className="thumb-prev mb-2 sm:mb-4 md:mb-10 cursor-pointer text-gray-500 z-20 hover:text-green-600 transition-colors"
            >
            ...
            <div className="w-full h-[180px] xs:h-[210px] sm:h-[280px] md:h-[320px] lg:h-[380px] overflow-hidden">
              <swiper-container
                ref={thumbsSwiperRef}
                init="false"
                class="w-full h-full"
