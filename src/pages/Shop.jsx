    ...
    <Container>
      <div className='flex flex-col lg:flex-row mt-6 gap-6'>
        ...
        <div className='w-full lg:w-[75%] font-pop'>
          ...
          <div className='flex justify-center mt-8 sm:mt-10 font-pop overflow-x-auto px-2'>
        <ul className='flex gap-1.5 sm:gap-3 items-center text-[#666666] flex-nowrap'>
          <li onClick={() => page > 1 && setPage(page - 1)} className='cursor-pointer shrink-0 p-1'>
            <FaAngleLeft className='text-[18px] sm:text-[20px] text-[#1A1A1A]' />
          </li>
          ...
          {Array(lastPage).fill(0).map((num, index) => (
            <li
              ...
              className={`cursor-pointer w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full text-xs sm:text-sm shrink-0 ${
          ...
          <li onClick={() => page < lastPage && setPage(page + 1)} className='cursor-pointer shrink-0 p-1'>
            <FaAngleRight className='text-[18px] sm:text-[20px] text-[#1A1A1A]'/>
          </li>
        </ul>
      </div>
        </div>
